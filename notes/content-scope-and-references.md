...
2026-08-12: 축약안과 본문별 외부 링크 배치를 적용했다. 하위 글은 35개에서 17개로 줄었다.
...
| 3.5 AI를 사용할 때의 책임 | 유지 | 기본 태도에서 원칙을 짧게 제시하고 5장에서 구체화한다. |
...
| 5.1 AI가 바꾼 OSS 기여 | 세 글을 합치기 | AI가 만든 변화, 문제가 되는 기여, 생산적인 활용을 한 흐름으로 설명한다. |
| 5.2 프로젝트의 AI 정책과 기여자의 책임 | 두 글을 합치기 | 프로젝트마다 다른 정책과 제출자가 져야 할 책임을 함께 설명한다. |
...
합칠 항목을 반영해 하위 글을 35개에서 17개로 줄였다. 4장은 여덟 글을 세 단계로, 5장은 다섯 글을 두 관점으로 묶었다.
