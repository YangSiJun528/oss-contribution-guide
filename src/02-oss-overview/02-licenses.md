...
회사에 재직 중인 경우, 개인 시간에 개인 장비와 계정으로 OSS에 기여하더라도 해당 기여가 회사 업무와 관련되거나 회사의 지식재산을 포함하면 사내 정책이나 지식재산권 관련 계약의 적용을 받을 수 있습니다.

따라서 기여 전에 근로계약과 사내 정책을 확인하고, 필요한 경우 회사의 담당 부서에 문의합니다.

일반적인 법적 배경은 [Open Source Guides의 법률 안내](https://opensource.guide/ko/legal/)를 참고하되, 구체적인 판단이 필요하면 관련 전문가의 조언을 받아야 합니다.
