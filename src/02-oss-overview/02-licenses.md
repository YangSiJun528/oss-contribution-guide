...
별도의 약정이 없다면 기여자는 자신이 작성한 부분의 저작권을 유지하면서 프로젝트와 사용자에게 해당 라이선스에 따른 이용 권한을 주는 것이 일반적입니다. OSS 라이선스로 기여한다고 해서 저작권이 자동으로 프로젝트에 넘어가는 것은 아닙니다.

프로젝트에서 CLA(Contributor License Agreement)나 DCO(Developer Certificate of Origin)를 요구할 수도 있습니다. CLA는 프로젝트마다 내용이 다른 별도의 동의서이며, 추가적인 이용 권한을 주거나 저작권 양도를 요구하는 조항이 있을 수도 있습니다. DCO는 서명 줄을 통해 자신이 해당 기여를 제출할 권리가 있음을 확인하는 방식이며, 저작권을 양도하는 문서는 아닙니다. 회사에 다니고 있다면 [기여를 시작하기 전에](../01-introduction/02-before-you-contribute.md#회사에-다니고-있다면)도 확인합니다.
