...
<figure>
  <a href="{{#include ../_includes/html-urls.md:spring-boot-3-5-0-m1-release}}"><img src="../assets/author-note/spring-boot-3.5.0-m1-contributors.png" width="607" loading="lazy"></a>
  <figcaption><a href="{{#include ../_includes/html-urls.md:spring-boot-3-5-0-m1-release}}">Spring Boot 3.5.0-M1 릴리스</a>의 기여자 목록입니다.</figcaption>
</figure>

제가 따로 알리지 않았는데도 다른 사람이 제가 기여한 기능을 이야기하는 모습을 본 적도 있습니다.

<figure>
  <a href="{{#include ../_includes/html-urls.md:spring-initializr-pr-1576}}"><img src="../assets/author-note/community-discussion-highlighted.png" width="320" loading="lazy"></a>
  <figcaption>맨 아래 메시지는 제가 추가한 기능에 관한 이야기입니다. 작업 내용은 <a href="{{#include ../_includes/html-urls.md:spring-initializr-pr-1576}}">Spring Initializr PR #1576</a>에서 볼 수 있습니다. 참여자의 이름과 프로필 사진은 가렸습니다.</figcaption>
</figure>
...
<figure>
  <img src="../assets/author-note/product-beta-outreach-email-redacted.png" width="800" loading="lazy">
...
<figure>
  <img src="../assets/author-note/research-collaboration-email-redacted.png" width="800" loading="lazy">
  <figcaption><a href="{{#include ../_includes/html-urls.md:linkedin-spam-example}}">LinkedIn 게시물</a>에서도 다뤄지는 스팸 메일입니다.</figcaption>
</figure>
