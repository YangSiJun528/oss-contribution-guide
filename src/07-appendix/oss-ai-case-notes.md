...
- AI가 바꾼 개발 비용
  ...
  - [실제 PR](https://github.com/oven-sh/bun/pull/30412)과 [Anthropic 설명](https://claude.com/blog/ai-code-migration)을 같이 연결
- 프로젝트의 AI 규칙
  - [Rust의 LLM 정책](https://forge.rust-lang.org/policies/llm-usage.html)
...
- 오픈소스 AI의 경계
  ...
  - [OSI의 Open Source AI Definition](https://opensource.org/ai/open-source-ai-definition) 연결
  - 기억한 Node 메인테이너 글은 확인되지 않았고, 유력한 글은 NixOS 관계자가 쓴 [Open weights are not open source](https://point.free/blog/open-weights-not-open-source/)임
- 출처·계보·재구현 문제
