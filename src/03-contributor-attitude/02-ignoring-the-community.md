...
참여자의 문제, 공동체의 문제로 나눌 수 있을 것 같은데요.

크게 다음과 같습니다.

관리자
1. 이해와 검증 없이 Issue나 PR을 제출하면 그 부담이 다른 참여자에게 넘어갑니다.   
2. 제출자가 변경 내용을 설명하지 못하면 다른 참여자가 문제의 타당성과 코드의 동작을 대신 확인해야 하며, 리뷰를 진행하기도 어렵습니다.

참여자
1. 제출자 자신도 해결 과정에서 얻은 지식을 다음 작업에 활용하기 어렵습니다.
2. 검증되지 않은 제출은 공개된 활동 기록으로 남아 이후 참여에서의 신뢰에도 영향을 줄 수 있습니다.

공동체
1. 결국 관리자에게 부담이 생기고, 참여자와 관리자 모두 공동체로써의 지식 형성 등을 이루어낼 수 없는 공허한 참여만 된다.

물론 AI를 의존해서 검수 없이 충분히 참여 가능한 작업들이 있을 수 있다. 하지만 이러한 것들은 충분히 합의가 되어야하고, 이러한 것들을 숨기고 참여하는 것은 바람직하지 않다.


TODO: 아래에 적절하게 제목이랑 세부 설명 ㄱㄱ
